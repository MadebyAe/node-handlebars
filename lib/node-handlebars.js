...
function ExpressHandlebars(config) {
  ...
  this.handlebarsVersion = ExpressHandlebars.getHandlebarsSemver(this.handlebars);
...
ExpressHandlebars.prototype.extname = '.html';
ExpressHandlebars.prototype.layoutsDir = 'app/views/layout/';
ExpressHandlebars.prototype.partialsDir = 'app/views/partial/';
